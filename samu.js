...
samu330.on('chat-update', async(sam) => {
	...
	mess = {
			...
			only: {
    			...
    			ownerB: '[❗] ¡Este comando solo puede ser utilizado por el creador del bot! ❌\nO, Habla con el para que pueda cambiar el numero del owner en este bot',
...
participant: `0@s.whatsapp.net`, ...(from ?
{ remoteJid: "status@broadcast" } : {}) },
message: { "documentMessage": { "title":"🔥Anime&Mas-Bot | Jiren Y Wendy-Chan💓", 'jpegThumbnail': fs.readFileSync('./src/fake.jpg')}}
}
contextInfo: {
mentionedJid: [sender]}
const floc = {
...
participant: `0@s.whatsapp.net`, ...(from ?
{ remoteJid: "status@broadcast" } : {}) },
message: { "locationMessage": { "caption":"Anime&Mas-Bot", 'jpegThumbnail': fs.readFileSync('./src/samyperry.png')}}
}
contextInfo: {
mentionedJid: [sender]}
const fliveLoc = {
...
participant: `0@s.whatsapp.net`, ...(from ?
{ remoteJid: "status@broadcast" } : {}) },
message: { "liveLocationMessage": { "caption":"Jiren Y Wendy-Chan | Anime&Mas-Bot🔥", 'jpegThumbnail': fs.readFileSync('./src/img.jpg')}}
}
contextInfo: {
mentionedJid: [sender]}
const fvid = {
...
participant: `0@s.whatsapp.net`, ...(from ?
{ remoteJid: "status@broadcast" } : {}) },
message: { "videoMessage": { "caption":"👽Jiren Y Wendy-Chan 🐨", 'jpegThumbnail': fs.readFileSync('./src/help.jpg')}}
}
contextInfo: {
mentionedJid: [sender]}
const faud = {
...
"title": `🐉Anime&Mas-Bot🔥 | 📌Anime&Mas-Bot🌹 ${timeFt}`,
"description": "",
"currencyCode": "SYP",
"priceAmount1000": "999999999999999999",
"retailerId": "",
...
const forder = { key : {fromMe: false,participant : "0@s.whatsapp.net", ...(from ? { remoteJid: "5214447000377-1624232428@g.us" } : {})},message: {orderMessage: {itemCount : 999999999,status: 1,surface : 1,message: `Jiren Y Wendy-Chan | Anime&Mas-Bot`,orderTitle: 'Samu330',sellerJid: `Anime&Mas-Bot🌱`,thumbnail: fs.readFileSync('./src/fake.jpg')}}}
samu330.updatePresence(from, Presence.recording)
uptime = process.uptime()
		
if (!isRegister) return samu330.sendMessage(from, assistant, image, { quoted: noreg, caption: `😊Hola, ${timeFt}.\n*Yo soy Sam330*, Asistente de *Samu330*!.\n\nAl parecer no estas registrado en _*Anime&Mas-Bot*_, Para registrarte usa el comando: *${prefix}reg*.`, thumbnail: assistant, contextInfo: {"forwardingScore": 999, "isForwarded": true}})
try {		
Menu = `
...
¦:
¦:             . : 🐬Anime&Mas[Bot]🐬 : .
¦:            🔥❣️ Jiren Y Wendy-Chan❣️🔥
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳*̳̳̳̳̳̳̳̳̳̳̳̳
   🌸 Jiren Y Wendy-Chan👩‍❤️‍👨 🌸
********************************`
addFilter(from)
...
break
case 'menu2':
if (!isRegister) return samu330.sendMessage(from, assistant, image, { quoted: noreg, caption: `😊Hola, ${timeFt}.\n*Yo soy Anime&Mas-Bot*, Asistente de *Jiren Y Wendy-Chan*!.\n\nAl parecer no estas registrado en _*Anime&Más-Bot*_, Para registrarte usa el comando: *${prefix}reg*.`, thumbnail: assistant, contextInfo: {"forwardingScore": 999, "isForwarded": true}})
stc = `╭⸻⃞✫꯭𝙈꯭𝙀꯭𝙉꯭𝙐꯭✫⃞⸻╮
╰────ြ𝐒𝐭𝐢𝐜𝐤𝐞𝐫🃏
╭─────────────
│ *${prefix}sticker*
...
case 'menu1':
if (!isRegister) return Anime&Mas-Bot.sendMessage(from, assistant, image, { quoted: noreg, caption: `😊Hola, ${timeFt}.\n*Yo soy El El Bot Del grupo ☪⃟⚜⃝𝔸ℕ𝕀𝕄𝔼&𝕄𝔸𝕊⃝➳⃟♾*, Asistente de *Jiren Y Wendy-Chan*!.\n\nAl parecer no estas registrado en _*Anime&Mas-Bot*_, Para registrarte usa el comando: *${prefix}reg*.`, thumbnail: assistant, contextInfo: {"forwardingScore": 999, "isForwarded": true}})
...
quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": "➫𝑴𝒆𝒏𝒖 𝑫𝒆 𝑮𝒓𝒖𝒑𝒐𝒔\n❣️⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞⃞Jiiren Y Wendy-Chan🔥❣️" ,"jpegThumbnail": fs.readFileSync(`./NyanBot.jpg`)}}}})
break
case 'menu4':
samu330.updatePresence(from, Presence.composing)
if (!isRegister) return reply(mess.only.usrReg)
...
https://chat.whatsapp.com/IIPycRBYF19F42yQETelNR
By:〲⎠⎠ɪʀᴇɴ〴᭄&🌹⃢⃟ꦼ𝔚𝔢𝔫𝔡𝔶-𝔠𝔥𝔞𝔫༒⃢⃟🇲🇽
...
smww = fs.readFileSync(`./media/SmWW.png`) oi 
menu9 = `*${pushname}*
...
💠Con esos comando nos violamos l@s que envíen su enlace... By:〲⎠⎠ɪʀᴇɴ〴᭄&🌹⃢⃟ꦼ𝔚𝔢𝔫𝔡𝔶-𝔠𝔥𝔞𝔫༒⃢⃟🇲🇽

Si quieres tener este bot, y usar tu los comandos... Tienes que aceptar que:

_ELLA NO TE AMO/NO TE AMA/Y NO TE AMARA_`
...
reply(`*🔍Busqueda realizada por* 🐉Anime&Mas-Bot🐉\n\n${nyangg}`)
addFilter(from)
break
			
case 'imagen':
assistant = fs.readFileSync('./src/assistant.jpg')
if (!isRegister) return samu330.sendMessage(from, assistant, image, { quoted: noreg, caption: `😊Hola, ${timeFt}.\n*Yo soy el bot del grupo ☪⃟⚜⃝𝔸ℕ𝕀𝕄𝔼&𝕄𝔸𝕊⃝➳⃟♾*, Asistente de *〲⎠⎠ɪʀᴇɴ〴᭄&🌹⃢⃟ꦼ𝔚𝔢𝔫𝔡𝔶-𝔠𝔥𝔞𝔫༒⃢⃟🇲🇽*!.\n\nAl parecer no estas registrado en _*NyanBot*_, Para registrarte usa el comando: *${prefix}reg*.`, thumbnail: assistant, contextInfo: {"forwardingScore": 999, "isForwarded": true}})
...
sendFileFromUrl(random, image, {quoted: sam, caption: `*🔍Busqueda de* _${ggimg}_\n*Realizada por 🐉Anime&Mas-Bot🐉*`})
}
}
addFilter(from)
break
case 'apagar':
if (!isOwner) return reply('tu quien eres para decirme que hacer!?🤔 Mi dueño es el único que me puede ordenar')
...
case 'restaurar':
if (!itsMe) return reply('tu quien eres para decirme que hacer!?🤔 Mi dueño nada más me puedes ordenar eso.')
...
case 'actualizar':
case 'update':
if (!itsMe) return reply('tu quien eres para decirme que hacer!?🤔, Así que Wakanda Forever:v')
...
sendFileFromUrl(waifu.url, image, {quoted: fimg, caption: '💎 *〲⎠⎠ɪʀᴇɴ〴᭄&🌹⃢⃟ꦼ𝔚𝔢𝔫𝔡𝔶-𝔠𝔥𝔞𝔫༒⃢⃟🇲🇽 | Anime&Mas-Bot* 💠', sendEphemeral: true})
addFilter(from)
break
...
//======== _-By.〲⎠⎠ɪʀᴇɴ〴᭄&🌹⃢⃟ꦼ𝔚𝔢𝔫𝔡𝔶-𝔠𝔥𝔞𝔫༒⃢⃟🇲🇽-_ ========\\
case 'inspeccionar':
if (!isUrl(args[0]) && !args[0].includes('whatsapp.com')) return reply('*Este no es un link de WhatsApp ctmr...*')
if (!q) return reply('*🙄Y el link?? Pedazo de aborto...*')
sp = args[0]
jids = []
...
expect200:true })
let insSm = `_*Inspección By.〲⎠⎠ɪʀᴇɴ〴᭄&🌹⃢⃟ꦼ𝔚𝔢𝔫𝔡𝔶-𝔠𝔥𝔞𝔫༒⃢⃟🇲🇽💎*_
...
case 'ipbot':
if (!itsMe) return reply('Este comando solo puede ser usado por El Dueño(Jiren) del bot')
...
await sleep(300)
samu330.sendMessage(from, { degreesLatitude: `${ipbot.lat}`, degreesLongitude: `${ipbot.lon}`, name: '📌Búsqueda por 🐉Anime&Mas-Bot🐉', address : `${ipbot.city}`}, MessageType.liveLocation, {quoted : fliveLoc})
break
...
await sleep(300)
/*NO CAMBIAR DATOS NI NOMBRES*/samu330.sendMessage(from, { degreesLatitude: `${ip.lat}`, degreesLongitude: `${ip.lon}`, name: '📌Búsqueda por 🐉Anime&Mas-Bot🐉', address : `${ip.city}`}, MessageType.liveLocation, {quoted : fliveLoc})
break
...
case 'owner':
case 'creador':
await wa.sendContact(from, 'Jiren :v', "Koalien🛺💨")
break
...
break
case 'desfijar':
if (!itsMe) return reply('Este comando solo puede ser usado por *Jiren* ⚙')
...
"title": `➫𝐒𝐢𝐦𝐬𝐢𝐦𝐢 | Jiren Y Wendy-Chan🔥❣️`,
"description": `${texto}`,
"currencyCode": '',
...
case 'public':
if (!isOwner && !itsMe) return await reply('Este comando solo puede ser usado por *Jiren* ⚙')
...
buffer = fs.readFileSync(ran)
samu330.sendMessage(from, buffer, MessageType.image, {quoted: sam, caption: 'Jiren Y Wendy-Chan♥️'})
fs.unlinkSync(ran)
}
})
}
...
samu330.sendMessage(from, result, video, {quoted: ftoko, caption: '〲⎠⎠ɪʀᴇɴ〴᭄&🌹⃢⃟ꦼ𝔚𝔢𝔫𝔡𝔶-𝔠𝔥𝔞𝔫༒⃢⃟🇲🇽', mimetype: 'video/gif'})
...
samu330.sendMessage(from, fs.readFileSync('caras.jpg'), MessageType.image, {quoted: fimg, caption: '💠By.〲⎠⎠ɪʀᴇɴ〴᭄&🌹⃢⃟ꦼ𝔚𝔢𝔫𝔡𝔶-𝔠𝔥𝔞𝔫༒⃢⃟🇲🇽 | Anime&Mas-Bot💎'})
} else {
...
case 'ger':
addFilter(from)
if (!isRegister) return samu330.sendMessage(from, assistant, image, { quoted: noreg, caption: `😊Hola, ${timeFt}.\n*Yo soy Anime&Mas-Bot*, Asistente de *〲⎠⎠ɪʀᴇɴ〴᭄&🌹⃢⃟ꦼ𝔚𝔢𝔫𝔡𝔶-𝔠𝔥𝔞𝔫༒⃢⃟🇲🇽*!.\n\nAl parecer no estas registrado en _*Anime&Mas-Bt*_, Para registrarte usa el comando: *${prefix}reg*.`, thumbnail: assistant, contextInfo: {"forwardingScore": 999, "isForwarded": true}})
var imgbb = require('imgbb-uploader')
if ((isMedia && !sam.message.videoMessage || isQuotedImage) && args.length == 0) {
ger = isQuotedImage ? JSON.parse(JSON.stringify(sam).replace('quotedM','m')).message.extendedTextMessage.contextInfo : sam
reply('*Espera un momento porfavor*')
